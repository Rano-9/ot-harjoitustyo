...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_negatiivinen_saldo_lataaminen_ei_muuta_saldoa(self):
        self.kortti.lataa_rahaa(-20000)

        self.assertEqual(self.kortti.saldo_euroina(),10.0)
    
    def test_kortilla_voi_ostaa_edullisen_lounaan_tasa_rahalla(self):
    ...
    def test_kortilla_voi_ostaa_maukkaan_lounaan_tasa_rahalla(self):
